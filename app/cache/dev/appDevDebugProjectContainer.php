...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->setProxyDir('/var/www/html/source/click/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\CsrfProvider\SessionCsrfProvider($this->get('session'), 'fe1088912a75ae1061b6ccf584876662fd');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ClickGallery' => 'Click\\GalleryBundle\\ClickGalleryBundle',
            ...
            'mailer_password' => '',
            'locale' => 'en',
            'csrf_secret' => 'fe1088912a75ae1061b6ccf584876662fd',
            ...
            'form.csrf_protection.secret' => 'fe1088912a75ae1061b6ccf584876662fd',
